...
class CompoundInterestTest(unittest.TestCase):
    def test_final_amount_1(self):
        result = CompoundInterest(100,.10,20)
        self.assertEqual(732.81, result.calculate())

    def test_final_amount_2(self):
        result = CompoundInterest(100,.06,10)
        self.assertEqual(181.94, result.calculate())
